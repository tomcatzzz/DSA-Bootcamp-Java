...
- [Rotate List](https://leetcode.com/problems/rotate-list/) `leetcode` `Microsoft` -- `done`
...
- [Find first node of loop in a linked list](https://www.geeksforgeeks.org/find-first-node-of-loop-in-a-linked-list/) `GFG` -- `done`
